...
define(function(require, exports, module) {
    ...
    Reflector.prototype.setBack = function setBack(node) {
        ...
        // var angle = new Transitionable(Math.PI);

        // reverse the backnode
        // var mirror = new Modifier({
        //     origin: [1, 0.5],
        //     // transform: Transform.thenMove(Transform.behind, Transform.rotateY(angle.get()))
        //     // transform: Transform.rotateY(angle.get())
        //     // transform: Transform.behind
        // });

        // this.backNode = _node.add(mirror).add(node);
        this.backNode = node;
    };
